    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="overflow-x-auto rounded-2xl bg-white border border-slate-200/80 shadow-sm">
        <table className="w-full text-left text-sm border-collapse">
          <thead className="sticky top-0 z-10 bg-slate-50/90 backdrop-blur-sm border-b border-slate-200 text-xs uppercase tracking-wider text-slate-600">
            <tr>
              {columns.map((col, idx) => (
              ...
              <tr>
                <td colSpan={columns.length} className="py-12 text-center text-slate-500">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="font-semibold text-slate-800 text-sm">{emptyTitle}</p>
